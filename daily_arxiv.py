...
def get_daily_papers(topic,query="Gradient Compression", max_results=2):
    """
    @param topic: str
    @param query: str
...
if __name__ == "__main__":
    ...
    keywords = dict()
    keywords["Gradient Compression"]                = "Gradient Compression"
    keywords["Distributed Training"]                 = "Distributed Training"+"OR"+"\"Structure from Motion\""
    keywords["Distributed Deep Learning"] = "\"Distributed Deep Learning\"OR\"Distributed Systems\"OR\"Communication in Distributed Deep Learning\"OR\"Parallel Training\"OR\"distributed training\""
